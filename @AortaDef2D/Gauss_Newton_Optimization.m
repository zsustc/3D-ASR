...
% control_pts_correspondence(obj);   % yanhao's method using normals
control_pts_correspondenceKNN(obj);
...
while(NeedOptimization)
    ...
    % re-initialize deformation parameters
    update_reinitialize_graph(obj);
    
    % update correspondence and control vertices
