classdef AortaDef2D < handle
    ...
    properties
        num_frames=3;            % number of frames used 
        Camera;
    ...
    properties
        ...
        iter = 50;
        StopIterationCriteria = 0.001; % 0.1
